...
class PetDef:
    ...
    ride_speed: float = 1.0                     # how much faster it moves while riding something (a sprite pack's `ride`)
    scold: tuple = ()                           # what it says when it scolds you (a character with arms points and wags its finger)
