...
def cli(argv):
    """handle `mochi autostart on|off|status` / `--version` without starting the GUI; True if it did"""
    ...
    ap.add_argument("command", nargs="?", choices=["autostart"], help="autostart: manage starting Mochi at login")
